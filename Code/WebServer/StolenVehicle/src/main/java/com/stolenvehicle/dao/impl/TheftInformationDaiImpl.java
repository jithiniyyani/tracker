...
public class TheftInformationDaiImpl extends AbstractDao implements
	...
	private static final class TheftInformationListResultSetExtractor implements
			ResultSetExtractor<List<TheftInformation>> {

		@Override
		public List<TheftInformation> extractData(final ResultSet resultSet)
				throws SQLException {
	...
	public TheftInformation getTheftInformation(String theftInformationId)
		...
		if (theftInformation == null) {
			...
			final Object attachmentList = this.fetch(
					Query.GET_VEHICLE_ATTACHMENTS_FOR_THEFT, new Object[] { vehicle_id },
	...
	public TheftInformation getTheftInformationByVehicleRegistrationNumber(
		...
		final Object theftInfoOjbect = this.fetch(
				Query.GET_THEFT_INFO_BY_REGISTRATION_NUMBER, new Object[] {registrationNumber},
				new TheftInformationResultSetExtractor());
		TheftInformation theftInformation = (TheftInformation) theftInfoOjbect;
		if (theftInformation == null) {
	...
	@Override
	public List<TheftInformation> getTheftInformationBySearchTo(
			SearchTo searchTo) throws BusinessException {

		final Object theftInfoListOjbect = this.fetch(
				Query.GET_THEFT_INFO_BY_SEARCH,
				new Object[] { searchTo.getType().toString(), searchTo.getMake(),
						searchTo.getCountry_id() },
