...
public class AttachmentServiceImpl implements AttachmentService {
	...
	// Improve this class
	@Override
	public List<AttachmentTo> saveAttachments(List<AttachmentTo> attachmentToList, String vehilceId,
		...
		for (AttachmentTo attachmentTo : attachmentToList) {
			attachmentList.add(ConversionUtil.convertAttachmentTo(attachmentTo));
		}
		List<Attachment> saveAttachmentList = attachmentDao.saveAttachmentList(attachmentList, vehilceId,
				findInformationId);
		attachmentToList = new ArrayList<AttachmentTo>();
		for (Attachment attachment : saveAttachmentList) {

			attachmentToList.add(ConversionUtil.convertAttachmentEntity(attachment));
		}
