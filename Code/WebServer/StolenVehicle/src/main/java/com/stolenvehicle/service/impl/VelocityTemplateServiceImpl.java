...
public class VelocityTemplateServiceImpl implements TemplateService {
	 ...
	 */
	@Override
	public String generateContent(final String vmFile, final String name,
			final Object object, final ResourceBundle resourceBundle) {
		...
		} catch (ResourceNotFoundException | MethodInvocationException
	 ...
	 * 
	 * @see
	 * com.ec.darwin.common.services.facade.iface.TemplateService#generateContent
	 * (java.lang.String, java.util.ResourceBundle, java.util.List,
	 * java.lang.Object[])
	 */
	@Override
	public String generateContent(String vmFile, ResourceBundle resourceBundle,
